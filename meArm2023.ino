...
#define pinServ1 2 // Giro
#define pinServ2 3 // Frente
#define pinServ3 4 // Sobe
#define pinServ4 5 // Garra
...
void loop(){
  ...
  motor2 = map(analogRead(pot2),0,1023,65,165);
  motor3 = map(analogRead(pot3),0,1023,10,90);
  motor4 = map(analogRead(pot4),0,1023,32,80);
